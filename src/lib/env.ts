...
export interface Env {
  LOGANVANTA_BEARER_AUTH?: string | undefined;

  LOGANVANTA_DEBUG?: boolean | undefined;
}

export const envSchema: z.ZodType<Env, z.ZodTypeDef, unknown> = z.object({
  LOGANVANTA_BEARER_AUTH: z.string().optional(),

  LOGANVANTA_DEBUG: z.coerce.boolean().optional(),
});
