 ...
 */
export async function auditsListAuditEvidence(
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.ListAuditEvidenceRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/audits/{auditId}/evidence")(pathParams);
