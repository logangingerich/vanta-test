 ...
 */
export async function auditsListAuditComments(
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.ListAuditCommentsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/audits/{auditId}/comments")(pathParams);
