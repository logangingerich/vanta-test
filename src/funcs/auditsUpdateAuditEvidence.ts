 ...
 * Update audit evidence.
 */
export async function auditsUpdateAuditEvidence(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.UpdateAuditEvidenceRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload.AuditEvidenceUpdateInput, {
    explode: true,
  });
  ...
  const path = pathToFunc("/audits/{auditId}/evidence/{auditEvidenceId}")(
    pathParams,
  );
